            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl z-50 px-4"
                    >
                        <div className="bg-background rounded-3xl overflow-hidden shadow-2xl border border-border relative">
                            {/* Close Button */}
                            <button
                                onClick={onClose}
                            ...
                            <div className="grid md:grid-cols-2">
                                ...
                                <div className="p-8 md:p-10 flex flex-col justify-center">
                                    ...
                                    <div className="mt-8 pt-6 border-t border-border">
                                        ...
                                        <Button
                                            className="w-full bg-gsb-green hover:bg-gsb-green/90 text-white font-bold rounded-full"
