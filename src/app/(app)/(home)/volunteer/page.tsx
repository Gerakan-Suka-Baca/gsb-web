      ...
      <section className="py-16">
        <div className="container mx-auto px-4 lg:px-6">
           <div className="text-center mb-12">
              <h2 className="text-3xl font-heading font-bold text-gsb-maroon dark:text-gsb-yellow mb-4">Budaya Kami</h2>
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {culture.map((item, idx) => (
                <FadeIn key={item.title} delay={idx * 0.1} className="bg-card border border-border p-6 rounded-2xl hover:shadow-md transition-all">
                   ...
                   <h3 className="text-lg font-bold text-gsb-maroon dark:text-gsb-yellow mb-2">{item.title}</h3>
