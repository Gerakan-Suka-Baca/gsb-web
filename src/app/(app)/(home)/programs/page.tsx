  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="minggu-cerdas" className="py-16 md:py-24">
        <div className="container mx-auto px-4 lg:px-6">
           <div className="mb-12">
             ...
             <h2 className="text-3xl md:text-4xl font-heading font-bold text-gsb-maroon mb-6">Minggu Cerdas</h2>
           ...
           <div className="grid lg:grid-cols-2 gap-12 mb-16">
              <FadeIn className="bg-card p-8 rounded-3xl shadow-sm border border-border">
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h3 className="text-2xl font-bold text-gsb-maroon">Lokasi Belajar</h3>
                </div>
              ...
              <FadeIn delay={0.2} className="bg-card p-8 rounded-3xl shadow-sm border border-border">
                 <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-gsb-maroon">Kurikulum Bulanan</h3>
                 </div>
      ...
      <section id="careducation" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-6">
           <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-gsb-maroon mt-2 mb-6">Careducation Movement</h2>
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {careducation.map((item, idx) => (
                 <FadeIn key={item.title} delay={idx * 0.1} className="p-8 rounded-3xl bg-background border border-border hover:border-gsb-tosca/50 transition-colors group">
                    ...
                    <h3 className="text-2xl font-bold text-gsb-maroon mb-3">{item.title}</h3>
      ...
      <section id="pendukung" className="py-16 md:py-24">
        <div className="container mx-auto px-4 lg:px-6">
           <h2 className="text-3xl font-heading font-bold text-gsb-maroon mb-12 text-center">Program Pendukung</h2>
