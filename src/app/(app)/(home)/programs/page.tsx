...
export default function ProgramsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-10 text-center">
          <FadeIn direction="up">
            <h1 className="text-4xl md:text-6xl font-heading font-bold text-responsive-maroon mb-6">
              Program <span className="text-responsive-orange">Kami</span>
            </h1>
      ...
      <section id="minggu-cerdas" className="py-12 md:py-16">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="mb-8">
            <span className="inline-block py-1 px-3 rounded-full bg-gsb-orange/10 text-responsive-orange text-sm font-bold mb-4">Program Unggulan</span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-responsive-maroon mb-6">Minggu Cerdas</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <FadeIn className="bg-card p-8 rounded-3xl shadow-sm border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-responsive-maroon">Lokasi Belajar</h3>
              </div>
            ...
            <FadeIn delay={0.2} className="bg-card p-8 rounded-3xl shadow-sm border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-responsive-maroon">Kurikulum Bulanan</h3>
              </div>
          ...
          <div className="bg-muted/30 p-6 md:p-8 rounded-3xl">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {phases.map((phase) => (
                <div key={phase.name} className="bg-background px-6 py-3 rounded-full shadow-sm border border-border flex flex-col items-center">
                  <span className="font-heading font-bold text-responsive-maroon">{phase.name}</span>
      ...
      <section id="careducation" className="py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-10">
            <span className="text-gsb-tosca font-bold tracking-wider uppercase text-sm">Social Enterprise</span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-responsive-maroon mt-2 mb-6">Careducation Movement</h2>
      ...
      <section id="pendukung" className="py-12 md:py-16">
        <div className="container mx-auto px-4 lg:px-6">
          <h2 className="text-3xl font-heading font-bold text-responsive-maroon mb-12 text-center">Program Pendukung</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <FadeIn key={prog.title} className="bg-muted/30 p-6 rounded-2xl hover:bg-muted/50 transition-colors">
                <prog.icon className="w-8 h-8 text-responsive-maroon mb-4" />
