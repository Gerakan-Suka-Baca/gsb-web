      ...
      >
        <Card className="p-6 md:p-8 flex flex-col gap-6 border-t-4 border-t-gsb-orange shadow-lg">
          ...
          <div className="flex flex-col gap-3 mt-4">
            {question.tryoutAnswers?.map((opt: any, idx: number) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    ...
                    isSelected
                      ? "border-gsb-orange bg-orange-50/80 shadow-sm"
                      : "border-border hover:border-gsb-orange/30"
                  )}
                >
                  <div className={cn(
...
export const TryoutExam = ({ tryout, onFinish }: TryoutExamProps) => {
  ...
  const unansweredCount = questions.length - Object.keys(answers[currentSubtest.id] || {}).length;
    ...
    <>
            ...
            <div className="flex items-center gap-3">
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button variant="outline" size="sm" className="h-9 w-9 p-0"><LayoutGrid className="w-4 h-4" /></Button>
                </SheetTrigger>
      ...
      <AlertDialog open={showConfirmFinish} onOpenChange={setShowConfirmFinish}>
        <AlertDialogContent className="select-none">
            ...
            <AlertDialogDescription>Kamu masih memiliki <span className="font-bold text-amber-600">{unansweredCount}</span> soal yang belum dijawab. Yakin?</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
