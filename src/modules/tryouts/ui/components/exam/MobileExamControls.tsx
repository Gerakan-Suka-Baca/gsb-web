...
export const MobileExamControls = ({
  ...
  ), [isOpen, questions, currentSubtestId, answers, flags, currentQuestionIndex, handleSelect]);
  ...
  useEffect(() => {
    setExamNavbarContent(
      <div className="flex items-center gap-3 md:gap-6">
        ...
        {/* Navigation Sheet - Stable reference */}
        {sheetContent}
      </div>
    );

    return () => setExamNavbarContent(null);
  }, [timeLeft, isWarning, formatTime, sheetContent, setExamNavbarContent]);
