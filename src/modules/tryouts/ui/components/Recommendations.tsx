      ...
      {data.recommendations.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {data.recommendations.map((rec: any, idx: number) => {
            ...
            return (
              <Card key={idx} className="p-5 border-border hover:border-primary/30 transition-colors bg-card flex flex-col h-full">
                <div className="flex-1">
                   <h3 className="font-bold text-lg leading-tight mb-1 line-clamp-2">{rec.name}</h3>
                ...
                <div className="mt-auto pt-4 border-t border-border flex items-center justify-between">
                   ...
                   <div className="text-right">
                     <span className="text-2xl font-black text-green-600 dark:text-green-500">{rec.chance}%</span>
                   </div>
                </div>
              </Card>
            )
